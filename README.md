...
• **Backend**: Firebase (Auth, Firestore, Cloud Functions) & REST APIs 

• **Database**: SQL Server, Hive (Offline Storage), and Data Migration 
...
• ☁️ Transitioning local desktop architectures into cloud-native Web APIs.

• 📱 Exploring advanced iOS automation and device-level integrations.
